      ...
      <main className="flex-grow p-6 md:p-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-semibold text-travel-dark mb-4">Account Settings</h2>
            <p className="text-gray-500">Manage your account preferences and settings here.</p>
          </div>
        </div>
      </main>
    </div>
