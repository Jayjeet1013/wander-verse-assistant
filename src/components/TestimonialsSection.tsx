      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Hear from travelers who have experienced the power of our
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="glass-card p-6 rounded-xl card-hover">
                  ...
                  <Star
                    ...
                    className={`h-5 w-5 ${
                      i < testimonial.rating
                        ? "text-travel-accent fill-travel-accent"
                        : "text-gray-300"
                    }`}
                  />
                ))}
              ...
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-travel-dark">
                    {testimonial.name}
                  </h4>
